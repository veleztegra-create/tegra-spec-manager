      ...
      const labelsHtml = page.map((formula) => {
        ...
        return `
          <article class="lab-label-card">
            <div class="lab-warning-banner">
              <img src="${esc(warningLabelSrc)}" alt="Etiqueta de seguridad" />
            </div>
            <header>
