...
export default class LayoutManager {
  ...
  setupEventListeners() {
    ...
    document.getElementById('placementImageInput').addEventListener('change', this.handlePlacementImageUpload.bind(this));
  }
  ...
  updatePlacementsTabs() {
    ...
    this.placements.forEach(placement => {
      ...
      tab.innerHTML = `
        ...
        ${this.placements.length > 1 ? `<span class="remove-tab" onclick="window.layoutManager.removePlacement(${placement.id})">&times;</span>` : ''}
      `;
